...
public class ConstantTransformer extends AbstractTransformer {

    public ConstantTransformer(Obfuscator obfuscator) {
        super(obfuscator);
    }
    ...
    private InsnList makeFloat(float value) {
        ...
        for (int retry = 0; retry < 10; retry++) {
            ...
            if (value / multiplier * multiplier == value) continue;
